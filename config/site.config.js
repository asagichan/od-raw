...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'terimakasih10@sdnydx.onmicrosoft.com',
  ...
  links: [
    {
      name: 'Website',
      link: 'https://asagichan.com/',
    },
    {
      name: 'Whatsapp',
      link: 'https://chat.whatsapp.com/Ha055uYS9ra8tj9tTIctG4',
    },
  ],
